...
Our implementation of a classic Carousel Slider, powered by our new Snap Slider for a super light CSS powered CSS slider.
...
2. Copy or merge the following files/folders into your theme:
   ...
   * `Magento_Theme/templates/elements/slider-a.phtml`
3. Replace the example `$items` with your own collection of slide data
...
or upgrade your Hyva theme module to version 1.3.13 or higher.her.
