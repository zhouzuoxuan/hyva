...
Elasticsuit
php bin/magento setup:install --base-url=https://preview.lencarta.com/ --db-host=127.0.0.1 --db-name=lencarta_prod --db-user=lencartalive --db-password='aZq@GU9xHVn5d52qr' --admin-firstname=zx --admin-lastname=z --admin-email=xuanphp@163.com --admin-user=zzx --admin-password='admin123' --language=en_GB --currency=USD --timezone=Europe/London --use-rewrites=1 --search-engine=elasticsuite --elasticsearch-host=127.0.0.1 --elasticsearch-port=9200
