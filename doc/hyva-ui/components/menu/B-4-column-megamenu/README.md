...
The Desktop Mega Menu B allows you to create a menu layout with top-level dropdown menus, multi-level column menus, and static content block integration.
...
[preview-1]: ./media/B-4-column-megamenu.jpg "Preview of the Menu B"
[preview-2]: ./media/B-4-column-megamenu-open.jpg "Preview of the Menu B open"
[preview-3]: ./media/B-4-column-megamenu-open-with-block.jpg "Preview of the Menu B open with a CMS block"
