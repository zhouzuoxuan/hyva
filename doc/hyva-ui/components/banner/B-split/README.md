...
1. Copy or merge the following files/folders into your theme:
   * `Magento_Cms/templates/elements/banner-b.phtml`
2. Adjust the content and code to fit your own needs and save
3. Create your development or production bundle by running `npm run watch` or `npm run build` in your
   theme's tailwind directory

> There's an example how to insert the `banner-b.phtml` into your homepage in `Magento_Cms/layout/cms_index_index.xml`
...
| `use_reverse`       | boolean | true, false         | false       | Reverse the image and content                                            |

> Link Options: `btn-primary`, `btn-secondary`, `btn`, `link`, `overlay`.

## Preview

![Preview of Banner B](./media/B-split.jpg)
