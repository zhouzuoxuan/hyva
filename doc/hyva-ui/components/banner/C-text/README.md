...
1. Copy or merge the following files/folders into your theme:
   * `Magento_Cms/templates/elements/banner-c.phtml`
2. Adjust the content and code to fit your own needs and save
3. Create your development or production bundle by running `npm run watch` or `npm run build` in your
   theme's tailwind directory

> There's an example how to insert the `banner-c.phtml` into your homepage in `Magento_Cms/layout/cms_index_index.xml`
...
![Preview of Banner C](./media/C-text.jpg)
